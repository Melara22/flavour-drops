...
<div id="comments here" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<?php
			$promo_cats = wp_get_post_terms( get_the_ID(), 'job_listing_category' );
			$author_id=$post->post_author;
			$user_meta=get_userdata($author_id);

			if (($user_meta->roles[0] == "premium") || ($user_meta->roles[0] == "vuira_team")) {
				$limit_to_show = '';
			}else{
				if($user_meta->roles[0] == "estandar"){
					$limit_to_show = 10;
				}
			}
